...
export default {
    ...
    sessionsByDeviceDonut: {
      ...
      chartOptions: {
        labels: ['Married', 'Single', 'Divorced', 'Widower'],
        dataLabels: {
          enabled: false
        },
        legend: { show: false },
        ...
        stroke: { width: 0 },
        colors: ['#2e9745', '#FF9F43', '#EA5455', '#1c31e2'],
        fill: {
          type: 'gradient',
          gradient: {
            gradientToColors: ['#39a848', '#FFC085', '#f29292', '#3547dcdb']
          }
        }
      }
    },
    ...
    productOrdersRadialBar: {
      ...
      // series: [70, 52, 26],
      chartOptions: {
        labels: ['Married', 'Single', 'Divorced', 'Widower', 'Total'],
        plotOptions: {
          radialBar: {
            size: 165,
            offsetY: -5,
        ...
        colors: ['#7961F9', '#FF9F43', '#EA5455', '#EA5355'],
        fill: {
          type: 'gradient',
          gradient: {
            // enabled: true,
            ...
            type: 'vertical',
            shadeIntensity: 0.5,
            gradientToColors: ['#9c8cfc', '#FFC085', '#f29292', '#EA5355'],
            inverseColors: false,
            opacityFrom: 1,
            opacityTo: 1,
            stops: [0, 100]
    ...
    customersPie: {
      ...
      // series: [690, 258, 149],
      chartOptions: {
        labels: ['Abuja', 'Suleja', 'Nassarawa', 'Gwagwalada', 'Dutse'],
        dataLabels: {
          enabled: false
        },
        legend: { show: false },
        ...
        fill: {
          type: 'gradient',
          gradient: {
            gradientToColors: ['#39a848', '#FFC085', '#f29292', '#536edf', '#f29292']
          }
        }
      }
    },
